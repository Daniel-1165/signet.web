    ...
    <section className="relative py-24 bg-foreground text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 space-y-8">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 text-white text-[10px] font-black uppercase tracking-widest border border-white/20">
             🌟 Mentoring Program
          </div>
          ...
          <ul className="space-y-4 pt-4 mb-8">
             <li className="flex items-center gap-3 text-white/80"><Clock className="text-accent w-5 h-5" /> 16th March - 15th June, 2026</li>
             <li className="flex items-center gap-3 text-white/80"><BookOpen className="text-accent w-5 h-5" /> 13 Core Curriculum Modules</li>
             <li className="flex items-center gap-3 text-white/80"><Shield className="text-accent w-5 h-5" /> Certificate of Participation</li>
          </ul>
        ...
        <div className="flex-1 w-full max-w-lg relative">
            <div className="grid grid-cols-2 gap-4">
                <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col items-start gap-4 hover:bg-white/10 transition-colors">
                    <Target className="w-8 h-8 text-accent" />
                    <h3 className="font-bold">Power of Vision</h3>
                    <p className="text-xs text-white/50">Aligning with purpose</p>
                </div>
                <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col items-start gap-4 hover:bg-white/10 transition-colors mt-8">
                    <BookOpen className="w-8 h-8 text-growth-green" />
                    <h3 className="font-bold">Self-Awareness</h3>
                    <p className="text-xs text-white/50">Understanding yourself</p>
                </div>
            </div>
