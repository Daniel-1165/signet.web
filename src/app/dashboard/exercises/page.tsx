  ...
  if (!userId || !user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-canvas text-ink">
        <h1 className="text-2xl font-semibold font-sans">Unauthorized</h1>
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink selection:bg-mist selection:text-seal pb-24 md:pb-12 pt-0 md:pt-12">
      ...
      <div className="flex md:hidden items-center justify-between px-6 py-6 border-b border-rule mb-8 bg-white/80 backdrop-blur-md sticky top-0 z-[40]">
        <div>
          <span className="text-[9px] font-semibold tracking-[0.25em] text-seal uppercase block mb-1">Daily Practice</span>
      ...
      <header className="hidden md:flex items-center justify-between px-10 py-10 max-w-[1400px] mx-auto border-b border-rule mb-16">
        <div>
           <div className="flex items-center gap-2 text-seal mb-2">
              <span className="text-[10px] font-semibold tracking-[0.3em] uppercase">Daily Practice</span>
           </div>
        ...
        <div className="flex items-center gap-8">
          <div className="relative group">
            ...
            <input 
              ...
              className="pl-11 pr-5 py-2.5 bg-white rounded-full text-sm border border-rule focus:border-seal outline-none  transition w-72 text-ink font-sans font-medium"
            />
          </div>
          <div className="flex items-center gap-5">
             ...
             <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-seal/20 "><UserButton /></div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1400px] mx-auto px-6 md:px-10 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="md:col-span-6 lg:col-span-4 bg-white rounded-[var(--radius-lg)] p-8 sm:p-10 border border-rule   hover:border-seal/30 transition duration-500 flex flex-col group relative">
             <div className="flex items-center justify-between mb-8 sm:mb-10">
                <div className="w-14 h-14 rounded-[var(--radius-lg)] bg-mist flex items-center justify-center text-seal group-hover:bg-seal group-hover:text-white transition-colors duration-300">
                   <Heart size={24} strokeWidth={1.5} />
                </div>
                <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-seal/40">
                   01
                </span>
             </div>
             ...
             <div className="mt-8 pt-6 sm:pt-8 border-t border-rule flex items-center justify-between">
                <div className="flex items-center gap-3 text-ink/50 uppercase tracking-widest text-[10px] font-semibold">
                   <Clock size={14} className="text-seal" />
                   <span>20 Mins</span>
                </div>
                <Link href="/eq-test" className="flex items-center gap-3 text-[12px] font-semibold uppercase tracking-widest text-ink hover:text-seal transition group-hover:translate-x-1 font-sans">
          ...
          <div className="md:col-span-6 lg:col-span-3 bg-white rounded-[2.1rem] p-6 sm:p-7 border border-rule   hover:border-seal/30 transition duration-500 flex flex-col group relative">
             <div className="flex items-center justify-between mb-6 sm:mb-8">
                ...
                <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-seal/40">
                   02
                </span>
             </div>
             ...
             <div className="mt-6 pt-5 sm:pt-6 border-t border-rule flex items-center justify-between">
                <div className="flex items-center gap-3 text-ink/50 uppercase tracking-widest text-[9px] font-semibold">
                   <Clock size={12} className="text-seal" />
                   <span>45 Mins</span>
                </div>
                <Link href="/iq-test" className="flex items-center gap-2 sm:gap-3 text-[11px] font-semibold uppercase tracking-widest text-ink hover:text-seal transition group-hover:translate-x-1 font-sans">
          ...
          <div className="md:col-span-6 lg:col-span-3 bg-white rounded-[2.3rem] p-7 sm:p-8 border border-rule   hover:border-seal/30 transition duration-500 flex flex-col group relative">
             <div className="flex items-center justify-between mb-7 sm:mb-9">
                <div className="w-12 h-12 sm:w-[50px] sm:h-[50px] rounded-[var(--radius-lg)] bg-mist flex items-center justify-center text-seal group-hover:bg-seal group-hover:text-white transition-colors duration-300">
                   <Eye size={22} strokeWidth={1.5} />
                </div>
                <span className="text-[10.5px] font-semibold uppercase tracking-[0.2em] text-seal/40">
                   03
                </span>
             </div>
             ...
             <div className="mt-7 pt-6 sm:pt-7 border-t border-rule flex items-center justify-between">
                <div className="flex items-center gap-3 text-ink/50 uppercase tracking-widest text-[9.5px] font-semibold">
                   <Clock size={13} className="text-seal" />
                   <span>Guided</span>
                </div>
                <Link href="/vision-guide" className="flex items-center gap-2 sm:gap-3 text-[11.5px] font-semibold uppercase tracking-widest text-ink hover:text-seal transition group-hover:translate-x-1 font-sans">
          ...
          <div className="md:col-span-6 lg:col-span-2 bg-seal hover:bg-seal rounded-[var(--radius-lg)] p-5 sm:p-6   transition duration-500 flex flex-col group relative text-white">
             <div className="flex items-center justify-between mb-6 sm:mb-8">
             ...
             <div className="mt-6 pt-5 border-t border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3 text-white/60 uppercase tracking-widest text-[9px] font-semibold">
                   <Clock size={12} className="text-white/80" />
                   <span>Cohort</span>
                </div>
                <Link 
                  href="/certificates" 
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full border border-white/20 hover:border-white/50 hover:bg-white/10 text-white text-[9px] sm:text-[10px] font-semibold uppercase tracking-wider transition-colors font-sans"
                >
                  <span>Initiate</span>
           ...
           <div className="flex items-center justify-between mb-12">
              <div>
                <div className="flex items-center gap-2 text-seal mb-2">
                   ...
                   <span className="text-[10px] font-semibold tracking-[0.3em] uppercase">Auditory Insight</span>
                </div>
