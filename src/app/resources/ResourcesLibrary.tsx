      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between py-6 gap-4 border-b border-gray-150/40">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[28px] md:text-[34px] font-semibold text-seal leading-tight tracking-tight">
                Resources
              </h1>
        ...
        {featured && (
          <section className="mt-8">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-[11px] font-semibold tracking-widest text-seal uppercase flex items-center gap-1.5">
            ...
            <div className="bg-surface rounded-3xl p-5 md:p-8 shadow-[0_10px_35px_rgba(0,0,0,0.02)] border border-gray-150/60 flex flex-col sm:flex-row gap-6 md:gap-10 relative overflow-hidden group">
              ...
              <div className="flex-1 flex flex-col justify-between py-1">
                <div>
                  ...
                  <h3 
                    onClick={() => featured.fileUrl && window.open(featured.fileUrl, '_blank')}
                    className="text-[20px] md:text-[28px] font-semibold text-seal leading-tight mt-3 hover:underline cursor-pointer"
                  >
                    {featured.title}
                  </h3>
              ...
              {curatedBooks.map((book: any, idx: number) => (
                ...
                >
                  ...
                  <button 
                    ...
                    className={`absolute top-4 right-4 p-1.5 rounded-full border transition-colors ${bookmarks.includes(book._id) ? 'bg-seal/10 border-seal text-seal' : 'bg-transparent border-transparent text-gray-400 hover:text-seal'}`}
                  >
                    <Bookmark size={16} className={bookmarks.includes(book._id) ? "fill-seal" : ""} />
                  </button>
                </div>
              ))}
            </div>
