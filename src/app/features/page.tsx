    ...
    <div className="relative min-h-screen bg-canvas text-ink font-sans selection:bg-mist selection:text-seal pb-20">
      <main>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-20">
                <div className="max-w-4xl space-y-8">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[11px] font-bold tracking-[0.4em] uppercase text-mist" >
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
            <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-16 md:gap-24 items-center">
                <div className="space-y-10">
                    <div>
                        <span className="text-[11px] font-bold tracking-[0.3em] text-seal uppercase mb-4 block font-sans" >The Foundation</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-10 border-t border-rule">
                        ...
                        <div className="bg-transparent p-0 border-0 shadow-none flex flex-col justify-between">
                            <div>
                                ...
                                <h4 className="text-[12px] font-bold uppercase tracking-[0.25em] text-seal mb-3">OUR VISION</h4>
                        ...
                        <div className="bg-seal rounded-[2rem] p-6 md:p-8 border border-rule/10 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
                            <div>
                                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white mb-6">
                                    <Flag size={20} />
                                </div>
                                <h4 className="text-[12px] font-bold uppercase tracking-[0.25em] text-verdant mb-3">OUR MISSION</h4>
                ...
                <div className="relative group">
                    <div className="bg-white rounded-[3rem] p-4 shadow-xl border border-rule overflow-hidden transform group-hover:scale-[1.01] transition-transform duration-500">
                        <img 
                            src={featuredImage} 
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 pb-16 md:pb-24">
            <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-rule shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="space-y-3 max-w-xl">
                    <span className="text-[10px] font-bold tracking-[0.3em] text-seal uppercase block font-sans">Reach Out</span>
        ...
        <section className="bg-seal text-white py-16 md:py-24 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-16 md:gap-24 items-start relative z-10">
                <div className="space-y-16">
                    <div>
                        <h4 className="text-[11px] font-bold tracking-[0.3em] uppercase text-mist/75 mb-8" >Program Duration</h4>
                        <div className="space-y-8">
                            <div className="flex gap-6 items-center">
                                <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-mist">
                                    <Calendar size={20} />
                                </div>
                ...
                <div className="bg-white rounded-[3rem] p-8 md:p-12 text-ink shadow-xl border border-rule space-y-8">
                    <div>
                        <h4 className="text-[11px] font-bold tracking-[0.3em] uppercase text-seal mb-3" >Your Gains</h4>
                    ...
                    <div className="space-y-6">
                        <div className="flex gap-5">
                            ...
                            <div>
                                <h5 className="font-bold text-[16px] mb-1 uppercase tracking-tight text-seal">Mastery of skills</h5>
                        ...
                        <div className="flex gap-5">
                            ...
                            <div>
                                <h5 className="font-bold text-[16px] mb-1 uppercase tracking-tight text-seal">A Certificate of Participation</h5>
                                ...
                                <ul className="space-y-2">
                                    {['Attendance to classes', 'Participation in team activities', 'Passing the assessment tests'].map(li => (
                                        <li key={li} className="flex items-center gap-3 text-[11px] font-bold text-ink/60 uppercase tracking-wider">
