      ...
      <div className="max-w-[1200px] mx-auto space-y-16">
          ...
          {books.length > 0 ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
               ...
               <div className="grid grid-cols-1 gap-6">
                  {books.slice(1).map((book: any, idx: number) => (
                     <button 
            ...
            <div className="py-12 text-center bg-white rounded-3xl border border-dashed border-[#bec9c4]/40">
               <p className="text-[#6e7975] text-sm italic">No books match your search.</p>
            </div>
          )}
        </section>
        ...
        <section>
          ...
          {magazines.length > 0 ? (
            ...
            <div className="py-12 text-center bg-white rounded-3xl border border-dashed border-[#bec9c4]/40">
               <p className="text-[#6e7975] text-sm italic">No magazines or journals found.</p>
            </div>
          )}
        </section>
