      ...
      <div className="flex-1 min-w-0 h-full">
        {selectedRoomId ? (
          ...
          <div className="h-full flex items-center justify-center">
            <div className="max-w-xl text-center p-20 bg-white rounded-[3.5rem] border border-rule/40 shadow-[0_30px_70px_rgba(0,0,0,0.03)] space-y-10 relative overflow-hidden">
               <div className="absolute top-0 right-0 w-64 h-64 bg-ink/5 blur-[80px]" />
               
               <div className="flex justify-center relative z-10">
                 <div className="w-24 h-24 rounded-[2rem] bg-ink/5 flex items-center justify-center text-ink">
               ...
               <div className="space-y-6 relative z-10">
                 ...
                 <h2 className="text-[44px] md:text-[52px] font-bold text-ink tracking-tight leading-tight" >
