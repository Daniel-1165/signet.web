...
export const GerminationAnimation = ({ className = "" }) => (
  <div className={`relative flex flex-col items-center justify-end h-64 w-full ${className}`}>
    ...
    <div className="w-1/2 h-4 bg-terra-soil rounded-full absolute bottom-2 opacity-30 " />
    ...
    <div className="relative bottom-4 flex flex-col items-center">
      ...
      <div className="w-1.5 h-32 bg-seal rounded-full animate-germinate relative">
        {/* Leaves */}
        <div className="absolute -left-6 top-10 w-8 h-4 bg-seal rounded-[100%_0%_100%_0%] rotate-[-20deg] " />
        <div className="absolute -right-6 top-4 w-8 h-4 bg-seal rounded-[0%_100%_0%_100%] rotate-[20deg] " />
        <div className="absolute -left-8 top-0 w-10 h-5 bg-seal rounded-[100%_0%_100%_0%] rotate-[-40deg] " />
